...
class DatosUbicacionUsuario(models.Model):
    ...
    zona = models.ForeignKey(sis_models.ZonaUbicacion, to_field='id_zubicacion', on_delete=models.CASCADE)
...
class IdentificacionUsuario(models.Model):
    ...
    tipo_identificacion = models.ForeignKey(sis_models.TipoIdentificacion, to_field='id_tidentificacion', on_delete=models.CASCADE)
...
class DatosBasicosUsuario(models.Model):
    ...
    genero_persona = models.ForeignKey(sis_models.TipoGenero, to_field='id_tgenero', on_delete=models.CASCADE, null=True)
    gp_rh = models.ForeignKey(sis_models.GpRh, to_field='id_grh',on_delete=models.CASCADE, null=True)
...
class DatosComplementariosUsuario(models.Model):
    ...
    fondo_pensiones = models.ForeignKey(sis_models.FondoPensiones, to_field='id_fpensiones', on_delete=models.CASCADE, null=True)
    eps = models.ForeignKey(sis_models.Eps, to_field='id_eps', on_delete=models.CASCADE, null=True)
